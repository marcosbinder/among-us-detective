 ...
 * Current fork:  https://github.com/Blaked84/highlight-within-textarea
 */
...
export default (function() {
  ...
  HighlightWithinTextarea.prototype = {
    ...
    fixFirefox: function() {
      ...
      marginProperties.forEach((p, i) => {
        this.backdrop.style[p] =
          "calc(" +
          getComputedStyle(this.backdrop)[p] +
          " + " +
          padding[i] +
          " + " +
          border[i] +
    ...
    fixIOS: function() {
      this.highlights.style["padding-left"] =
        "calc(" + getComputedStyle(this.highlights)["padding-left"] + " + 3px)";
      this.highlights.style["padding-right"] =
        "calc(" +
        getComputedStyle(this.highlights)["padding-right"] +
        " + 3px)";
    },
